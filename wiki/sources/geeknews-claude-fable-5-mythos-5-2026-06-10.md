...
이번 ingest는 사용자가 제공한 GeekNews 글을 기준으로 하되, 연결된 공식 발표는 [[Anthropic Claude Fable 5 and Mythos 5 Announcement]]으로 별도 ingest했다. 제품 정책과 공식 주장은 공식 source summary를 우선 사용하고, 이 페이지는 한국어 요약과 초기 사용자 반응 신호에 사용한다.
